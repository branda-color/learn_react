...
const App = () => {
  ...
  const fetchCurrentWeather = () => {
    ...
    fetch(
      `https://opendata.cwb.gov.tw/api/v1/rest/datastore/O-A0003-001?Authorization=${AUTHORIZATION_KEY}&stationId=${LOCATION_NAME}`
    )
